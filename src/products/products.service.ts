...
export class ProductsService {
  ...
  async update(id: string, updateProductDto: UpdateProductDto) {
    ...
    //Creamos el Query runner porque al actualizar puede que necesitemos hacer un rollback si hay errores
    ...
    try {
      ...
      //await this.productRepository.save(product); Este sería el guardado sin query runner
